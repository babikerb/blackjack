...
type BarMode = 'rec' | 'blackjack' | 'lost' | 'win'
...
export default function App() {
  ...
  async function stand() {
    ...
    if (isNaturalBlackjack(dCards)) {
      ...
      if (currentDealerScore > calcScore(playerCards)) setGameOver('Player Wins!')
    }
  }
          ...
          <>
            ...
            <AiRecommendBar
              ...
              mode={
                ...
                : gameOver === 'BUST You win!' ? 'win'
                : gameOver === 'Player Blackjack' ? 'win'
                : gameOver === 'Dealer Blackjack' ? 'lost'
                : 'rec'
              }
            />
