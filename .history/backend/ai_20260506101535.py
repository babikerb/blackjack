...
def monte_carlo_action(
    ...
    hit_amount = stand_amount = 0

    for i in range(simulation_quantity):
        hit_amount = _simulate_hand(players_hand, dealers_card, 'hit', simulation_deck)
        stand_amount = _simulate_hand(players_hand, dealers_card, 'stand', simulation_deck)
